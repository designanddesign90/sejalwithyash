/* ─────────────────────────────────────
   ...
   the architecture.
───────────────────────────────────── */
const MAP_URL ="https://www.google.com/maps/place/Akm+Resorts/@30.6461527,76.8087747,650m/data=!3m1!1e3!4m6!3m5!1s0x390feb3b53f7947b:0xf50c945f38cd2b3a!8m2!3d30.6461527!4d76.8087747!16s%2Fg%2F11fhwwlvpw!18m1!1e1?entry=ttu&g_ep=EgoyMDI2MDYwMS4wIKXMDSoASAFQAw%3D%3D";
const MAP_URL_G = "https://www.google.com/maps/place/Green+Estate/data=!4m2!3m1!1s0x0:0xac74ab8397e23711?sa=X&ved=1t:2428&hl=en-IN&ictx=111";
const MAP_URL_AR = "https://www.google.com/maps/place/Amour+-+The+Grand+Ballroom/data=!4m2!3m1!1s0x0:0x1e5634918b3eb1a4?sa=X&ved=1t:2428&ictx=111";

const EVENTS = [
  {
    id: "mehendi",
    icon: "pn-evt-ico-rings-x-v01.webp",
    name: "The Day we said yes",
    date: "17 June 2026", time: "7:00 PM",
    venue: "AMOUR THE GRAND BALLROOM ",
    note: "Mrs. Poonam & Mr. Nitin Jindal invites you for the Ring Ceremony of her Daughter",
    map: MAP_URL_AR
  },
  {
    id: "haldi",
    icon: "pn-evt-div-hanuman ji-x-v01.webp",
    name: "Sunderkand Path",
    date: "21 June 2026", time: "6:00 PM",
    venue: "#8,9,10 GREEN ESTATE DERABASSI",
    note: "Sh. Sukhdev Jindal requests the pleasure of your presence at holy Path",
    map: MAP_URL_G
  },
  {
    id: "sangeet",
  ...
  {
    id: "shaadi",
    icon: "pn-evt-ico-mehendi-x-v01.webp",
    name: "Ishq ka Rang",
    date: "23 June 2026", time: "11:00 AM",
    venue: "#8,9,10 GREEN ESTATE DERABASSI ",
    note: "Varsha & Nandini invite you to celebrate a Hena Memories",
    map: MAP_URL_G
  },
  {
    id: "reception",
    ...
    venue: "GRAND ORIENT",
    note: "Mrs. Meenakshi & Mr. Vipan Jindal , Mrs. Anu & Mr. Rishi Jindal , Mrs. Divya & Vivek Jindal invites you on cocktail celebrations",
    map: MAP_URL
  },
  {
    id: "vidaai",
    ...
    venue: "# 8,9,10 GREEN ESTATE DERABASSI",
    note: "Madhav, Keshav, Atulya invites you at sufi night filled with music & rytheme",
    map: MAP_URL_G
  }
];
...
───────────────────────────────────── */
const A = {
  darkBg:      "pn-hro-bg-courtyard-dark-m-v03.webp",
  litBg:       "pn-hro-bg-courtyard-lit-m-v03.webp",
  darkBgDesktop: "pn-hro-bg-courtyard-dark-D-v03.webp",
  litBgDesktop:  "pn-hro-bg-courtyard-lit-d-v03.webp",
  rope:        "pn-hro-el-rope-hemp-pull-x-v01.webp",
  lotusClosed: "pn-rvl-btn-lotus-closed-x-v01.webp",
  lotusOpen:   "pn-rvl-btn-lotus-open-x-v01.webp",
  lotusGlow:   "pn-fx-ovl-lotus-glow-burst-x-v01.webp",
  jhoomer:     "pn-shr-mot-jhoomer-hanging-x-v01.webp",
  floralBush:  "pn-shr-mot-floral-bush-cluster-x-v01.webp",
  diya:        "pn-shr-mot-diya-glow-x-v01.webp"
};
...
${noteHtml}
          ...
          ${mapHtml}${evt.map ? `<div class="farman-map-rule" aria-hidden="true"></div>` : ""}
        </div>
      </div>`.trim();
    ...
    if (i < EVENTS.length - 1) {
      ...
      if (i === LOTUS_AFTER_INDEX) {
        ...
        inter.innerHTML = `<img src="pn-inv-div-lotus-divider-x-v01.webp"
...
(function applyConfigPhase1() {
  ...
  function fmtEvDate(iso) {
    if (!iso) return '';
    var parts = iso.split('-');
    var d = parseInt(parts[2], 9), m = parseInt(parts[1], 10), y = parts[0];
